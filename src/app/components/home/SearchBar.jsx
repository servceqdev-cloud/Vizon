          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
            ...
            <div className="flex items-end">
              <button
                ...
                className="w-full px-3 cursor-pointer py-2 bg-[#04A1FF] hover:bg-blue-400 text-white  rounded-xl transition-all shadow-lg hover:shadow-xl flex items-center justify-center gap-2 text-lg"
              >
